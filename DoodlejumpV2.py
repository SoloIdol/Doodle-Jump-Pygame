...
platform_neon_image=pygame.image.load('assets/neonplatform.png').convert_alpha()
...
while run == True:
    ...
    if game_over == False:
        ...
        draw_text('GAME OVER',font_big,WHITE,SCREEN_WIDTH // 2-70,SCREEN_HEIGHT //2-100)
        draw_text('SCORE: ' + str(score),font_big,WHITE,SCREEN_WIDTH // 2-55,SCREEN_HEIGHT //2-50)
        draw_text('PRESS SPACE TO RESTART',font_big,WHITE,SCREEN_WIDTH // 2-150,SCREEN_HEIGHT //2)
        key = pygame.key.get_pressed()
